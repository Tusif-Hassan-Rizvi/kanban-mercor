      ...
      <section className={`${styles.mainbox_topbar}`}>
        ...
        <div className={`${styles.projectname_links}`}>
          ...
          <div className={`${styles.invite_people}`}>
            {/* invite icon  */}
            <Image src={Inviteicon} width={15} height={15} alt="invite icon" />
            {/* invite text  */}
            <span>Invite</span>
            {/* invite users  */}
            <div>0</div>
        ...
        <div className={`${styles.filter_sort}`}>
          ...
          <div className={`${styles.filter_today}`}>
            <div className={`${styles.filter}`}>
              ...
              />
              <span>Filter</span>
              <Image src={downArrow} width={16} height={16} alt="down arrow" />
            </div>
          ...
          <div className={`${styles.share_viewtype}`}>
            ...
            <div className={`${styles.view_grid}`}>
              <Image src={GridIcon} width={20} height={20} alt="view grid" />
            </div>
          </div>
        </div>
      </section>
