            ...
            <div className={`${styles.main_container}`}>
                ...
                <section className={`${styles.to_do} ${styles.common_box}`}>
                    ...
                    <div className={`${styles.task_box_top_bar}`}>
                        {/* circle  */}
                        <div className={`${styles.task_box_circle}`}>
                    ...
                    {/* seprator line  */}
                    <div className={`${styles.taskbox_seprator_line}`} style={{ background: '#800080', border: "3px solid #5030e5" }}>
                    </div>
                ...
                <section className={`${styles.on_progress} ${styles.common_box}`}>
                    ...
                    <div className={`${styles.task_box_top_bar}`}>
                        {/* circle  */}
                        <div className={`${styles.task_box_circle}`} style={{ background: "#FFA500" }}>
                    ...
                    {/* seprator line  */}
                    <div className={`${styles.taskbox_seprator_line}`} style={{border: "3px solid #FFA500" }}>
                    </div>
                </section>
                ...
                <section className={`${styles.on_done} ${styles.common_box}`}>
                    ...
                    <div className={`${styles.task_box_top_bar}`}>
                        {/* circle  */}
                        <div className={`${styles.task_box_circle}`} style={{ background: "#76A5EA" }}>
                    ...
                    {/* seprator line  */}
                    <div className={`${styles.taskbox_seprator_line}`} style={{border: "3px solid #8BC48A" }}>
                    </div>
                </section>
            </div>
        </>
